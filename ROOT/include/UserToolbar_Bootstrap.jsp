...
<c:if
	test="${(sessionScope.onlineUser.generalManager || sessionScope.onlineUser.isHigherEqualThanMANAGER)}">
	<div class="btn-group btn-group-sm" role="group" aria-label="...">
		...
		<a class="btn btn-default"
			href="./EditUserConfig?id=${user.id}" role="button"
		...
		<a class="btn btn-default" href="./Problems?ownerid=${user.id }"
			...
			class="glyphicon glyphicon-tasks"></span></a><a class="btn btn-default"
