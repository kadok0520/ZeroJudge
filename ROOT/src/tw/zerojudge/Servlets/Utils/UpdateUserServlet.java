...
public class UpdateUserServlet extends HttpServlet implements IAccessFilter {
	...
	public void AccessFilter(HttpServletRequest request) throws AccessException {
		...
		if (account != null && !onlineUser.getAccount().equals(account) && !onlineUser.getIsDEBUGGER()) {
			ArrayList<String> debugs = new ArrayList<String>();
			debugs.add("onlineUser=" + onlineUser.getAccount() + "(" + onlineUser.getUsername() + ") 嘗試修改他人的資料 "
					+ request.getRequestURI());

			Alert alert = new Alert(Alert.TYPE.ROLEERROR, "您沒有權限進行這一個動作！", "請勿修改他人資料！", "", null, debugs);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String account = request.getParameter("account") == null ? onlineUser.getAccount()
		...
		request.setAttribute("user", new UserService().getUserByAccount(account));
