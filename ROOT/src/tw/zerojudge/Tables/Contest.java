...
public class Contest implements Serializable {
	...
	private Integer config = Integer.valueOf("0101111110", 2); 
	...
	public void setUserrules(String userrules) {
		...
		this.setUserrules(new Utils().String2LinkedHashSet(userrules));
	}
	...
	public void doStop() throws DataException {
		...
		new ContestDAO().doFinishContestants(this.getId());
	}
