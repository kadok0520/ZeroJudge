...
<body>
									...
									<td><div>
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												...
												<p class="help-block">redirect_uri: 重導向 uri 必須有 domain
													或者導向 localhost 測試用。</p>
											</div>
										</div></td>
								</tr>
							</table>
 ...
 -->
						<button type="submit" class="btn btn-success" id="submit">儲存</button>
					</div>
				</div>
			</form>
 ...
 -->
	<jsp:include page="include/Footer_Bootstrap.jsp" />
