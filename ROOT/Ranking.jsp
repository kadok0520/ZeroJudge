 ...
 --%>
			...
			<table class="table table-hover">
				<tr>
					...
					<td colspan="6" class="col-md-6"><fmt:message key="Ranking.SolveStatus" /></td>
				</tr>
				<c:choose>
							...
							<tr id="${user.account}">
								...
								<td><c:set var="user" value="${user}"
										...
										<span class="DEBUGGEROnly"> <c:if
												test="${user.generalManager}">
												<img src="images/ICO_GeneralManager.png" title="站務管理員" />
											</c:if> <c:if test="${user.problemManager}">
								...
								<td><div align="left">
										...
										<span style="font-size: small;">( <fmt:formatNumber
												value="${user.ac/problemnum}" type="percent" /> )
										</span>
									</div></td>
								<td><div style="text-align: left; font-size: smaller">
