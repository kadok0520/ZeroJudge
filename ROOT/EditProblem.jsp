...
<body>
 ...
 -->
	...
	<div class="container-fluid">
		<a href="EditProblems?tabid=${problem.tabid}" class="btn btn-primary">回題目管理</a>
		<div class="row">
			<div class="col-md-6">
							...
							<div class="alert alert-danger">
								...
								<br />
									...
									<input name="sortable" type="hidden"
										...
										type="submit" name="updateProblem" value=" 儲存 "
						...
						<table class="table-hover">
							<tr>
								<td><jsp:include
									...
									type="button" class="btn btn-success" id="save_ProblemSettings"
									value="儲存" data-problemid="${problem.problemid }" /></td>
							</tr>
						</table>
					</div>
				</div>
 ...
 -->
													...
													<div id="SpecialJudgeHint">
														...
														<div>
															...
															<jsp:include page="include/Modals/Modal_ShowSpecialJudgeCode.jsp"/>
															<strong>評分程式：</strong><button type="button" class="btn btn-default" data-toggle="modal"
	...
	jQuery(document).ready(function() {
		$("input[name='specialjudge_language']").each(function() {
 		...
 		$('input[type=radio][name=specialjudge_language]').change(function() {
			...
			$.getJSON("./Problem.json?data=GetSpecialJudgeCode&problemid=" + problemid + "&specialjudge_language=" + specialjudge_language, function(data) {
		        ...
		        $("textarea[name='specialjudge_code']").html("");
											...
											<input class="btn btn-success"
												name="saveUploadSpecialJudgeFiles" value="儲存" />
										</form>
									</fieldset>
								</td>
							</tr>
