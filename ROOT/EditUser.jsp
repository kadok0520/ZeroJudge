		...
		<div class="row">
			<c:if test="${applicationScope.appConfig.isGoogleLoginSetup}">
				<a href="./InsertGoogleUser"
					class="btn btn-primary btn-lg btn-block"> 用 Google 帳號註冊新帳號</a>
				<hr>
			</c:if>
			<form class="form-horizontal">
				<div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label"><fmt:message
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<input name="schoolid" id="otherschoolradio" type="radio"
							...
							name="otherschoolname" id="otherschoolname" type="text" size="30"
							maxlength="50" /><br /> 學校網頁：<input name="otherschoolurl"
							id="otherschoolurl" type="text" size="30" maxlength="50" />
					</div>
				</div>
